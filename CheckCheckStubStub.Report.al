report 50134 "Check Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CheckReport.rdl';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(BankAcctNo; BankAccRec."Bank Account No.") { }
            dataitem(CheckPages; "Integer")
            {
                ...
                begin
                    ...
                    UseCheckNo := IncStr(UseCheckNo);//Avi++++
                    // UseCheckNo := (UseCheckNo);//Avi++++
